...
namespace ITHit.FileSystem.Samples.Common.Windows.ShellExtension
{
    ...
    /// </summary>
    public class ContextMenusProviderCommon : ContextMenusProviderBase
    {
        ...
        public override async Task<string> GetIconAsync(IEnumerable<string> filesPath)
        {
            ...
            string iconPath = Path.Combine(Path.GetDirectoryName(typeof(ContextMenusProviderCommon).Assembly.Location), iconName);
