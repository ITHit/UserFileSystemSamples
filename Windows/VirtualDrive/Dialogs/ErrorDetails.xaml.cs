...
using VirtualDrive.ViewModels;

namespace VirtualDrive.Dialogs
{
    /// <summary>
    ...
    public sealed partial class ErrorDetails : DialogWindow
    {
        ...
        public ErrorDetails(FileEventViewModel eventMovel, VirtualEngine engine, LogFormatter logFormatter, AppSettings settings) : base()
        {
            this.logFormatter = logFormatter;
            InitializeComponent();
            Resize(1000, 700);
            resourceLoader = ResourceLoader.GetForViewIndependentUse();
            Title = $"{settings.ProductName} - {resourceLoader.GetString("ErrorDetailsWindow/Title")}";
            ...
            RemoteStoragePath.Text = settings.RemoteStorageRootPath;
