...
namespace WebDAVDrive
{
    ...
    internal class VirtualFile : VirtualFileSystemItem, IVirtualFile
    {
        ...
        public VirtualFile(string userFileSystemFilePath, ILogger logger) 
            : base(userFileSystemFilePath, logger)
        {
        ...
        {
            return await CreateOrUpdateFileAsync(new Uri(RemoteStorageUri), fileInfo, FileMode.Open, content, eTagOld, lockInfo);
        }
    }
}
